<script lang="ts">
  ...
  import DataTransferPanel from "../../components/management/DataTransferPanel.svelte";
...
<svelte:head>
  ...
  {:else}
    <section class="management-grid">
      <DataTransferPanel onmerge={loadManagement} />
