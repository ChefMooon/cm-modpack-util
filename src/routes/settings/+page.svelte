...
<main class="settings-shell">
  ...
  <div class="settings-layout">
    ...
    <div class="detail-pane">
      ...
      <section id="about" class="settings-section" aria-labelledby="about-title"><p class="eyebrow">About</p><h2 id="about-title">CM Modpack Util</h2><div class="setting-card about-card"><p>A local-first foundation for registered modpack projects.</p><p class="muted">Version 0.0.7</p></div></section>
