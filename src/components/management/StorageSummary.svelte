...
<section class="storage-card" aria-labelledby="storage-title">
  ...
  {#if report.unavailable_categories.length}<p class="notice" role="status">Unavailable observations: {report.unavailable_categories.join(", ")}.</p>{/if}
