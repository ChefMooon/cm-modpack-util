<script lang="ts">
  ...
  import type { Evidence, InventoryEntry, ModpackOverview, ModpackRecord, ObservationFreshness } from "../../lib/domain";

  let { inspected, overview, inventory, observationAt, observationFreshness, inventoryFilter = $bindable("all"), overviewLoading, inventoryLoading, overviewError, inventoryError, inspecting, pinningEntry, evidenceLabel, freshnessLabel, freshnessTitle, onclose, onreread, onopenPage, onpin, onretry }: {
